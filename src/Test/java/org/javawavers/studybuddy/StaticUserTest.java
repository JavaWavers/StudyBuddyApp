...
public class StaticUserTest {
  ...
  public void testStaticUserInitialization() {
    ...
    assertEquals(
        "testUser",
        StaticUser.staticUser.getUsername(),
        "Username should match the initialized value");
    assertEquals(
        "test@example.com",
        StaticUser.staticUser.getEmail(),
  ...
  public void testUpdateUserDetails() {
    ...
    assertEquals(
        "newUsername", StaticUser.staticUser.getUsername(), "Username should update correctly");
    assertEquals(
        "newEmail@example.com", StaticUser.staticUser.getEmail(), "Email should update correctly");
  }
  ...
  public void testAddNonAvailDay() {
    ...
    assertTrue(
        StaticUser.staticUser.getNonAvailDays().contains(LocalDate.of(2025, 1, 3)),
  ...
  public void testRemoveNonAvailDay() {
    ...
    assertFalse(
        StaticUser.staticUser.getNonAvailDays().contains(LocalDate.of(2025, 1, 1)),
  ...
  public void testAddSubject() {
    ...
    assertTrue(
        StaticUser.staticUser.getSubjects().contains(newSubject),
        "Subject should be added to the list");
  }
  ...
  public void testRemoveSubject() {
    ...
    assertFalse(
        StaticUser.staticUser.getSubjects().contains(subjectToRemove),
