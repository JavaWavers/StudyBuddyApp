...
public class User {
    ...
    public User(int userID, String username, String email, String password, int[] avPerDay, List<LocalDate>nonAvailDays, List<Subject> subjects, List<Assignment> assignments, List<Exam> exams,  List<Task> tasks, List<Day> days) {
        this.email = email;
        this.password = password;
        this.avPerDay = avPerDay;
        this.nonAvailDays = nonAvailDays;
    ...
    public List<LocalDate> getNonAvailDays() {return nonAvailDays;}
