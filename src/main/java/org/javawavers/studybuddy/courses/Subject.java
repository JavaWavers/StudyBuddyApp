...
/**
 * Represents a subject. A subject includes details such as its name, difficulty level, type, study
 * goals, and related exams and assignments.
 */
public class Subject {
  ...
  // Constructors
  /**
   * Constructs a Subject with the given name. Default values: difficulty level = 1, subject type =
   * Αγνωστο, study goal = GOOD.
   *
