...
public class AssDistributionCalc {
  ...
  /**
  * Calculates and returns the distribution of tasks as a percentage for each assignment.
  * return A HashMap where the key is the assignment name, and the value is the percentage of tasks.
  */
  ...
  /**
  * Calculates the percentage of tasks assigned to each assignment.
  * The method processes the user's task data by iterating through the weeks,
  * days, and scheduled tasks. It counts the tasks assigned to each assignment and computes
  * their percentage relative to the total number of tasks.
  * The calculated percentages are stored in the {@code assDist} map.
  */
