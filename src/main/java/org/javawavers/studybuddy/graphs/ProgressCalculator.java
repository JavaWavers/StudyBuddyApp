...
public class ProgressCalculator {
  ...
  // λιστα με τα συνολικα Tasks που εχει το καθε μαθημα (αυτο θα το παιρνουμε απο τον αλγοριθμο) με
  // τα ονοματα των task --> ονομα task , subject
  ...
  public double calculateProgressofSubject(Subject subject) {
    ...
    countsubject++;
    // αρχικοποιηση μετρητων που θα βοηθησουν για να μετρησουμε τα task που εχει
    // ξεκινησει,ολοκληρωση,αργησει να παραδωσει, δεν τα εχει αρχισει ακομα
    int notStartedYet = 0;
    int ongoing = 0;
    int late = 0;
    int completed = 0;
    ...
    int totaltask = 0;
    // παιρνουμε το ονομα του task και το μαθημα που ανηκει το συγκεκριμενο task και αν ανηκει στο
    // μαθημα που εχει για ορισμα η μεθοδος τοτες προστιθεται ενα στα συνολικα task του μαθηματος
    // αυτου(totaltask)
    for (List<String> taskinfo : totalTasksPerSubject) {
      ...
      if (tasksubject.equals(subject)) {
        totaltask++;
        // παιρνουμε την κατασταση και το ονομα του task ψαχνουμε να βρουμε ποτε ειναι ιδιο το ονομα
        // του task ωστε να τα ταιριαξουμε και στην συνεχεια αφου ειναι ιδιο μπαινει μεσα στην if
        // και προστιθεται ενα αναλογα το status του task
    ...
    // υπολογιζουμε την προοδο ως τα task που εχουν ολοκληρωθει / τα συνολικα task του μαθηματος επι
    // 100 για το ποσοστο
  ...
  public void calculateDistribution() {
    ...
    // για το καθε μαθημα υπολογιζουμε την προοδο του δια την συνολικη προοδο επι 100 για να βρουμε
    // το ποσοστο του συγκεκριμενου μαθηματος
