...
/**
 * The {@code PrintSchedule} class is responsible for printing the user's study schedule in a
 * human-readable format. This includes displaying daily tasks based on the provided schedule matrix
 * and task list, as well as indicating non-available days.
 */
