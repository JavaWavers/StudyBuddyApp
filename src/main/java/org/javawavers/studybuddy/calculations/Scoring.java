...
public class Scoring {
   ...
   * The scoring considers various factors such as: - Task repetition penalties for the same subject
   * on the same day. - Penalties for scheduling the same subject for study two days in a row. The
   * score starts at 5.0 and is reduced based on the conditions outlined above.
   *
   * @param taskList The list of tasks (study, revision, assignments) that have been assigned in the
   *     schedule.
