...
Τα διαγράμματα UML που ακολουθούν παρουσιάζουν τον σχεδιασμό και τη δομή του κώδικα της εφαρμογής **StudyBuddy**. Απεικονίζουν τις σχέσεις μεταξύ των κλάσεων, τα χαρακτηριστικά και τις μεθόδους τους, προσφέροντας μια ολοκληρωμένη εικόνα της αρχιτεκτονικής της εφαρμογής.
...
### Βοηθητικά Εργαλεία
- **IconsManager**: Διαχειρίζεται εικονίδια και στοιχεία γραφικού περιβάλλοντος.
- **DateData**: Υποστηρίζει λειτουργίες και υπολογισμούς που σχετίζονται με ημερομηνίες.

## Διαγράμματα UML

### Διάγραμμα 1: Σχεδιασμός Υψηλού Επιπέδου
> Το διάγραμμα αυτό αναδεικνύει τα βασικά στοιχεία της εφαρμογής και τις μεταξύ τους σχέσεις, όπως το `StudyBuddyApp`, το `SQLiteConnection`, και τα βασικά βοηθητικά στοιχεία.

### Διάγραμμα 2: Διεπαφή Χρήστη και Αλληλεπιδράσεις
> Εμφανίζει τις σχέσεις μεταξύ των σελίδων της εφαρμογής (όπως `LoginPage`, `RegisterPage`, `DashboardPage`) και τις βασικές λειτουργίες τους.

### Διάγραμμα 3: Διαχείριση Εργασιών και Δεδομένων
> Εστιάζει στις κλάσεις `Task`, `Exam`, και `Subject`, αναδεικνύοντας τη διαχείριση δεδομένων και λογικής.

## Ενσωματωμένες Εικόνες

1. **Σχεδιασμός Υψηλού Επιπέδου**:
   ![Διάγραμμα UML 1](path/to/uml-diagram-1.png)

2. **Διεπαφή Χρήστη και Αλληλεπιδράσεις**:
   ![Διάγραμμα UML 2](path/to/uml-diagram-2.png)

3. **Διαχείριση Εργασιών και Δεδομένων**:
   ![Διάγραμμα UML 3](path/to/uml-diagram-3.png)

## Συμπεράσματα

Τα διαγράμματα UML προσφέρουν μια λεπτομερή και ολοκληρωμένη παρουσίαση της δομής και της αρχιτεκτονικής της εφαρμογής. Οι σαφείς σχέσεις μεταξύ των κλάσεων εξασφαλίζουν ότι ο σχεδιασμός είναι αρθρωτός, συντηρήσιμος και επεκτάσιμος.
