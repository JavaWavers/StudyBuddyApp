...
3. **Διαχείριση Εργασιών και Δεδομένων**:
   - Απεικονίζει τις κλάσεις `Task`, `Exam`, και `Subject`, αναδεικνύοντας τη διαχείριση δεδομένων και λογικής.

![Ενοποιημένο Διάγραμμα UML](path/to/uml-diagram.png)
...
[Πρόσβαση στο Διάγραμμα UML](https://auebgr-my.sharepoint.com/:u:/g/personal/t8230220_aueb_gr/EZ-8QiOMsH5ChI6UexZdhm0Bg8sZAh20Hl8d0IdpQIAlYg?e=bL3XyN)
...
- [Επισήμως Έγγραφα UML](https://www.uml.org/)
- [Τεκμηρίωση GitHub](https://docs.github.com/)
